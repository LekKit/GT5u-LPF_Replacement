    ...
    private static void registerMultiblockControllers() {
        ...
        ItemList.Machine_Multi_Canner.set(
            new GT_MetaTileEntity_MultiCanner(MULTI_CANNER_CONTROLLER.ID, "multimachine.canner", "TurboCan Pro")
                .getStackForm(1));
        ItemList.Machine_Multi_FluidSolidifier.set(
            new GT_MetaTileEntity_MultiFluidSolidifier(MULTI_FLUIDSOLIDIFIER_CONTROLLER.ID, "multimachine.fluidsolidifier","multi Fluid Solidifier")
                .getStackForm(1));
    }
