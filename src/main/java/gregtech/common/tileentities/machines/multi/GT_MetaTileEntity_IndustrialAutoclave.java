...
public class GT_MetaTileEntity_IndustrialAutoclave
    extends GT_MetaTileEntity_EnhancedMultiBlockBase<GT_MetaTileEntity_IndustrialAutoclave> implements ISurvivalConstructable {

    private static final String STRUCTURE_PIECE_MAIN = "main";
    private static final IStructureDefinition<GT_MetaTileEntity_IndustrialAutoclave> STRUCTURE_DEFINITION = StructureDefinition
        .<GT_MetaTileEntity_IndustrialAutoclave>builder()
        .addShape(
        ...
        .addElement(
            'A',
            buildHatchAdder(GT_MetaTileEntity_IndustrialAutoclave.class)
                ...
                .buildAndChain(
                    onElementPass(
                        GT_MetaTileEntity_IndustrialAutoclave::onCasingAdded,
                        ofBlock(GregTech_API.sBlockCasings2, 0))))
        .addElement('B', ofBlock(GregTech_API.sBlockCasings2, 13))
        .build();

    public GT_MetaTileEntity_IndustrialAutoclave(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public GT_MetaTileEntity_IndustrialAutoclave(String aName) {
        super(aName);
    }

    @Override
    public IStructureDefinition<GT_MetaTileEntity_IndustrialAutoclave> getStructureDefinition() {
    ...
    public IMetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_IndustrialAutoclave(this.mName);
    }
